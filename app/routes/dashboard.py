...
def dashboard():
    ...
    value_bets = ValueBet.query.order_by(ValueBet.edge_percentage.desc()).limit(25).all()
    upcoming_games = (
    ...
    best_lines_by_game = {
        game.id: best_lines_from_snapshots(odds_by_game[game.id]) for game in upcoming_games
    }
